...
impl OpeningKey {
    pub fn new(g1s: Vec<G1Projective>, g2s: Vec<G2Projective>, multi_opening_size : usize, num_coefficients_in_polynomial : usize) -> Self {
        Self { g1s, g2s, multi_opening_size, num_coefficients_in_polynomial }
    }
